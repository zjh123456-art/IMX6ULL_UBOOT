 ...
 */
#ifndef __MX6ULL_ZJH_EMMC_CONFIG_H
#define __MX6ULL_ZJH_EMMC_CONFIG_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			...
			\	/*"if test $board_name = mx6ull_zjh_emmc && test $board_rev = 14X14; then " \
					"setenv fdt_file imx6ull-14x14-evk.dtb; fi; " \ */ \
				"if test $fdt_file = undefined; then " \
...
#define CONFIG_BOOTCOMMAND \
	...
	"fatload mmc 1:1 0x83000000 imx6ull-14x14-emmc-7-800x480-c.dtb;" \
